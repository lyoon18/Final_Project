...
As shown in the table above, although CART has the shortest runtime, it also generates the lowest accuracy rate. Whereas for the 
...
## String Cleaning Ingredient Variables
...
As shown in the confusion matrix plot above, this trimmed Random Forest model achieved an accuracy rate of 69.8% and only took 15 minutes to run! All cuisines were predicted correctly, but the strength of the predictions vary. For example, Italian was predicted the 
